...
class TestBuildThreadFilterClauses:
    ...
    def test_user_id_clause_is_always_present(self) -> None:
    ...
    def test_status_clause_added_when_provided(self) -> None:
    ...
    def test_metadata_clause_added_when_provided(self) -> None:
    ...
    def test_auth_filter_clause_added_when_present(self) -> None:
    ...
    def test_unsupported_values_filter_raises_400(self) -> None:
    ...
    def test_empty_or_none_values_filter_does_not_raise(self) -> None:
...
class TestCountThreadsUnit:
    ...
    @pytest.mark.asyncio
    async def test_count_threads_executes_scalar_query(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_count_threads_returns_zero_when_scalar_is_none(self) -> None:
